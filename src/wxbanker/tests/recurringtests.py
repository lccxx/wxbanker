...
from bankobjects.recurringtransaction import RecurringTransaction #@UnresolvedImport
...
class RecurringTest(testbase.TestCaseWithController):
    ...
    def testGetChildren(self):
        model, account = self.createAccount() #@UnusedVariable
        ...
        t = account.AddTransaction(1) #@UnusedVariable
        self.assertLength(rt.GetChildren(), 0)
