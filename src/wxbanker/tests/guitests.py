...
from wxbanker import main, controller #@UnusedImport
import os, wx, unittest #@UnusedImport
...
class GUITests(testbase.TestCaseHandlingConfigBase):
    ...
    def testKeyboardAccountShortcuts(self):
        model = self.Model
        accountList = self.AccountListCtrl #@UnusedVariable
    ...
    def testInitialBalanceHint(self):
        ...
        a = self.Model.CreateAccount("testInitialBalanceHint") #@UnusedVariable
    ...
    def testCanCheckRecurringTransactions(self):
        ...
        rt = a.AddRecurringTransaction(1, "fun", testbase.today, 0) #@UnusedVariable
    ...
    def testSearch(self):
        ...
        t1 = a.AddTransaction(1, "Cat") #@UnusedVariable
