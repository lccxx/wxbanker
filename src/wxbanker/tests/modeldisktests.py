...
from wxbanker import controller, bankobjects #@UnusedImport
...
import os, unittest #@UnusedImport
...
class ModelDiskTests(testbase.TestCaseWithControllerOnDisk):
    ...
    def testAutoSaveDisabledSimple(self):
        ...
        a1 = model1.CreateAccount("Checking Account") #@UnusedVariable
    ...
    def testAutoSaveDisabledComplex(self):
        ...
        self.Controller.AutoSave = False
        t2 = a1.AddTransaction(-10, "Description 3") #@UnusedVariable
    ...
    def testLinkedTransferIsStored(self):
        a, b, atrans, btrans = self.createLinkedTransfers() #@UnusedVariable
        model1 = self.Controller.Model
