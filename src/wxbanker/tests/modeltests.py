...
import os, datetime, unittest #@UnusedImport
from wxbanker import controller, bankexceptions, currencies #@UnusedImport
...
class ModelTests(testbase.TestCaseWithController):
    ...
    def testCannotCreateAccountWithSameName(self):
        a = self.Model.CreateAccount("A") #@UnusedVariable
    ...
    def testTransactionPropertyBug(self):
        model1 = self.Controller.Model
        a = model1.CreateAccount("A")
        t1 = a.AddTransaction(-1) #@UnusedVariable
    ...
    def testAnnouncedAccountHasParent(self):
        ...
        baby = self.Model.CreateAccount("Baby") #@UnusedVariable
    ...
    def testRemovingTransactionsReturnsSources(self):
        ...
        ta, tb = a.AddTransaction(1, source=b) #@UnusedVariable
    ...
    def testTransferMoveDescriptionWithDescription(self):
        ...
        at, bt = a.AddTransaction(1, description="hello world", source=b) #@UnusedVariable
