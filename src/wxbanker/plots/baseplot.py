...
try:
    import numpy.oldnumeric as _Numeric #@UnusedImport
except:
    try:
        import numarray as _Numeric  #if numarray is used it is renamed Numeric @UnusedImport @Reimport @UnresolvedImport
    except:
        try:
            import Numeric as _Numeric #@Reimport @UnresolvedImport
        except:
            _Numeric = None
